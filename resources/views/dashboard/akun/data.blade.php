                        ...
                        <div class="row justify-content-between mt-3">
                            ...
                            <div class="col-5 my-2 fw-bold">
                                <div class="point mb-3">
                                    ...
                                    <input type="number" class="form-control border-top-0 border-end-0 border-start-0 " id="no_hp" aria-describedby="namaHelp" style="background-color:#F3FFE4">                                      
                                </div>
                                <div class="point mb-3">
                                ...
                                <div class="point mb-3">
                                    ...
                                    <input type="number" class="form-control border-top-0 border-end-0 border-start-0 " id="no_hp_ayah" aria-describedby="namaHelp" style="background-color:#F3FFE4">                                      
                                </div>
                                <div class="point mb-3">
                                    <label for="" class="form-label" style="font-size: 18px">Pekerjaan Ibu :</label>
                                    <input type="number" class="form-control border-top-0 border-end-0 border-start-0 " id="no_hp_ibu" aria-describedby="namaHelp" style="background-color:#F3FFE4">                                  
                                </div>
                            </div>
                        </div>
